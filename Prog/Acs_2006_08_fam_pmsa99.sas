/**************************************************************************
 Program:  Acs_2006_08_fam_pmsa99.sas
 Library:  Ipums
 ...
 Modifications: 2/18/2010 KEF for 2006_08 ACS data
**************************************************************************/
...
/*proc datasets library=Ipums memtype=(data);
  delete Acs_2006_08_fam_pmsa99;
quit;*/

%let revisions = New file.;

data Ipums.Acs_2006_08_fam_pmsa99
       (compress=binary 
        label="ACS microdata, calculated family types (HH level), 2006_08, Washington, D.C. PMSA (1999)");
...
x "purge [dcdata.Ipums.data]Acs_2006_08_fam_pmsa99.*";

** File info **;

%File_info( data=Ipums.Acs_2006_08_fam_pmsa99, freqvars=gq )

** Register with metadata system **;

%Dc_update_meta_file(
  ds_lib=Ipums,
  ds_name=Acs_2006_08_fam_pmsa99,
  creator_process=Acs_2006_08_fam_pmsa99.sas,
