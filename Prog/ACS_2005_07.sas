...
data 
  ipums.ACS_2005_07_DC (label="IPUMS ACS sample, 2005-2007, DC")
  ipums.ACS_2005_07_MD (label="IPUMS ACS sample, 2005-2007, MD")
  ipums.ACS_2005_07_VA (label="IPUMS ACS sample, 2005-2007, VA")
  ipums.ACS_2005_07_WV (label="IPUMS ACS sample, 2005-2007, WV")
  ;
...
;
  ...
  ** Output files by state **;
  ...
  select ( statefip );
    when( &FIPS_DC ) output Ipums.ACS_2005_07_DC;
    when( &FIPS_MD ) output Ipums.ACS_2005_07_MD;
    when( &FIPS_VA ) output Ipums.ACS_2005_07_VA;
    when( &FIPS_WV ) output Ipums.ACS_2005_07_WV;
    otherwise do;
...
%File_info( data=Ipums.ACS_2005_07_DC, printobs=5, freqvars=statefip acre: gq vacancy )
