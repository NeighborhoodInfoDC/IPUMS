/**************************************************************************
 ...
 Description:  Create format for ACS Occupation Codes (OCC) for 2010.
 
 Source: L:\Libraries\IPUMS\Doc\IPUMS ACS Occupation Codes (OCC).xlsx
...
proc format library=Ipums;
  ...
  value occac10f
    ...
    1530 = 'Miscellaneous engineeers including nuclear engineers'
    1540 = 'Drafters'
    ...
    1965 = 'Miscellaneous Life, Physical, and Social Science Technicians, Including Social Science Research Asistants'
    2000 = 'Counselors'
    2010 = 'Social Workers'
...
/*    3945 = 'Transportation Security Screeners'*/
    ...
    4710 = 'First-Line Supervisors of Non-Retail Sales'
    4720 = 'Cashiers'
    ...
    6765 = 'Miscellaneous construction workers including solar Photovaltaic Installers, and septic tank servicers and sewer pipe cleaners'
    ...
    8220 = 'Miscellaneous metal workers and plastic workers including milling and planing machine setters, and multiple machine tool setters, and lay-out workers'
    8030 = 'Machinists'
    ...
    9750 = 'Miscellaneous material moving workers including shuttle car operators, and tank car, truck, and ship loaders'
...
proc catalog catalog=Ipums.formats;
  modify occac10f (desc="Occupation codes for ACS 2010") / entrytype=format;
  contents;
quit;
