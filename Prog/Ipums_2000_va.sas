...
* Environment:  Windows
* 
* Description:  Read in IPUMS 2000 data for VA.
*
* Modifications:
************************************************************************;
...
*options fmterr obs=10;

** Define libraries **;
%DCData_lib( Ipums )

data ipums.Ipums_2000_VA (label="IPUMS 5% sample data, 2000, VA");
infile 'D:\DCData\Libraries\IPUMS\Raw\ptati003.dat' LRECL=536;
input
 year         1-  2
 datanum      3-  4
 serial       5- 12
...
label
 ...
 elVAh="Age of eldest own child in household"
 ...
 gchouse="GranVAhildren living in this house"
 gcmonths="Months responsible for granVAhildren"
 gcrespon="Responsible for granVAhildren"
...
%File_info( data=Ipums.Ipums_2000_VA, printobs=5, freqvars=statefip acre: )
