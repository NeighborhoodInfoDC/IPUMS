/**************************************************************************
 ...
 Description:  Read IPUMS 2013 ACS data and create data sets 
 for NC.
...
libname indat "L:\Libraries\IPUMS\Raw\North Carolina\usa_00032.sas7bdat";

%let input_data_sets = usa_00032;
...
;
  ...
  ** Earnings, education, and occupational status scores **;
  ...
  /*
  ** HUD income categories, will be calucated in the tabulation program **;
