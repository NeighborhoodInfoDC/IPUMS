/**************************************************************************
 Program:  Acs_2004_fam_pmsa99.sas
 Library:  Ipums
...
data Ipums.Acs_2004_fam_pmsa99
       (compress=binary 
        label="ACS microdata, calculated family types (HH level), 2004, Washington, D.C. PMSA (1999)");
...
x "purge [dcdata.Ipums.data]Acs_2004_fam_pmsa99.*";

** File info **;

%File_info( data=Ipums.Acs_2004_fam_pmsa99, freqvars=gq )

** Register with metadata system **;

%Dc_update_meta_file(
  ds_lib=Ipums,
  ds_name=Acs_2004_fam_pmsa99,
  creator_process=Acs_2004_fam_pmsa99.sas,
