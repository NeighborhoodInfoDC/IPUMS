...
* 
* Description:  Create formats for IPUMS data.
*  NB: Removed blank formats from original IPUMS code.
*
* Modifications:
*   11/23/04  Made corrections to PROPTXJJ, codes 67 & 68.
************************************************************************;
