/**************************************************************************
 ...
 Description:  Read IPUMS 2017 ACS data and create data sets 
 for NC.
...
libname indat "L:\Libraries\IPUMS\Raw\North Carolina\usa_00028.sas7bdat";

%let input_data_sets = usa_00028;
...
;
  ...
  ** Earnings, education, and occupational status scores **;
  ...
  /*
  ** HUD income categories, will be calcualted in the tabulation program with the income limit spreadsheet **;
