...
* Environment:  Windows
* 
* Description:  Read in IPUMS 2000 data for WV.
*
* Modifications:
************************************************************************;
...
data ipums.Ipums_2000_WV (label="IPUMS 5% sample data, 2000, WV");
infile 'D:\DCData\Libraries\IPUMS\Raw\ptati004.dat' LRECL=536;
input
 year         1-  2
 datanum      3-  4
 serial       5- 12
...
label
 ...
 elWVh="Age of eldest own child in household"
 ...
 gchouse="GranWVhildren living in this house"
 gcmonths="Months responsible for granWVhildren"
 gcrespon="Responsible for granWVhildren"
...
%File_info( data=Ipums.Ipums_2000_WV, printobs=5, freqvars=statefip acre: )
