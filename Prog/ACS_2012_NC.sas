...
libname indat "L:\Libraries\IPUMS\Raw\North Carolina\usa_00033.sas7bdat";

%let input_data_sets = usa_00033;
...
;
  ...
  ** Earnings, education, and occupational status scores **;
  ...
  /*
  ** HUD income categories, will be calculated in the tabulation program **;
