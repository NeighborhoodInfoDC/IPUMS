...
* Environment:  Windows
* 
* Description:  Read in IPUMS 2000 data for MD.
*
* Modifications:
************************************************************************;
...
data ipums.Ipums_2000_MD (label="IPUMS 5% sample data, 2000, MD");
infile 'D:\DCData\Libraries\IPUMS\Raw\ptati002.dat' LRECL=536;
input
 year         1-  2
 datanum      3-  4
 serial       5- 12
...
label
 ...
 elMDh="Age of eldest own child in household"
 ...
 gchouse="GranMDhildren living in this house"
 gcmonths="Months responsible for granMDhildren"
 gcrespon="Responsible for granMDhildren"
...
%File_info( data=Ipums.Ipums_2000_MD, printobs=5, freqvars=statefip acre: )
