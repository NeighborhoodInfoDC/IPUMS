/**************************************************************************
 ...
 Description:  Read raw IPUMS 2016 single year ACS data for vacant housing 
...
filename asciidat "&_dcdata_r_path\ipums\raw\rp\usa_00108.dat";
