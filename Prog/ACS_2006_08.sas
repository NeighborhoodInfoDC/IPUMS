/**************************************************************************
 ...
 Updated: 2/16/10 KF for 2006-08
**************************************************************************/
...
filename asciidat "&_dcdata_path\ipums\raw\usa_00007.dat";
...
infile asciidat LRECL=1252 pad stopover;
...
;
  ...
  ** Recode n/a values **;
  ...
  /*owncost not included in 2006-08 data*/
  ...
  array incc{*} ftotinc hhincome valueh inctot;
  ...
  ** Remove extraneous format associations **;
  /*some variables not included in 2006-08 data*/
