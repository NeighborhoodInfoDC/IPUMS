/**************************************************************************
 Program:  Acs_2008_fam_pmsa99.sas
 Library:  Ipums
 ...
 Modifications: 2/18/2010 KEF for 2008 ACS data
**************************************************************************/
...
/*proc datasets library=Ipums memtype=(data);
  delete Acs_2008_fam_pmsa99;
quit;*/

%let revisions = New file.;
%let revisions = %str(Rerun with 2008 file update.);

data Ipums.Acs_2008_fam_pmsa99
       (compress=binary 
        label="ACS microdata, calculated family types (HH level), 2008, Washington, D.C. PMSA (1999)");
...
x "purge [dcdata.Ipums.data]Acs_2008_fam_pmsa99.*";

** File info **;

%File_info( data=Ipums.Acs_2008_fam_pmsa99, freqvars=gq )

** Register with metadata system **;

%Dc_update_meta_file(
  ds_lib=Ipums,
  ds_name=Acs_2008_fam_pmsa99,
  creator_process=Acs_2008_fam_pmsa99.sas,
