/**************************************************************************
 ...
 Description:  Compare formats for two versions of IPUMS file.
...
proc format cntlout=fmts2005 (drop=decsep dig3sep datatype language);
...
%File_info( data=fmts2005, printobs=40, stats= )


proc format cntlout=fmts2000 (drop=decsep dig3sep datatype language);
...
%File_info( data=fmts2000, printobs=40, stats= )

run;

proc sort data=fmts2005;
  by fmtname start end;

proc sort data=fmts2000;
  by fmtname start end;

proc compare base=fmts2005 compare=fmts2000 maxprint=(40,32000);
  id fmtname start end;
  var label;
